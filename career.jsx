...
window.CAREER_DATA = [
  {
    id: "c1",
    company: "Anthropic-adjacent Labs",
    position: "Senior AI Systems Engineer",
    term: "2025 — present",
    year: "2025",
    location: "Remote · SG",
    summary: "Lead architect for graph-native retrieval and multi-agent orchestration on internal tooling.",
    achievements: [
      "Shipped SYNAPSE.search: 40M-doc hybrid retrieval at sub-80ms p95",
      "Designed multi-agent debate protocol for technical Q&A",
      "Mentored 4 engineers across retrieval, evals, and infra",
    ],
  ...
  },
  {
    ...
    year: "2023",
    location: "Singapore",
    summary: "Built the model-serving + observability platform powering 12 production ML services.",
    achievements: [
      "Reduced p95 inference latency by 62% via custom Triton kernels",
      "Stood up shared evaluation harness adopted by 4 teams",
      "Authored the agency's responsible-AI deployment guideline",
    ],
  ...
  },
  {
    ...
    year: "2022",
    location: "Singapore",
    summary: "Service-mesh reliability for the regional fintech stack across 6 markets.",
    achievements: [
      "Owned Envoy sidecar rollout to 800+ services",
      "Cut tail-latency 38% with adaptive retry budgets",
      "Built anomaly-detection PoC that became COVENANT.ids",
    ],
  ...
  },
  {
    ...
    position: "Research Assistant · Graph ML",
    term: "2021 — 2022",
    year: "2021",
    location: "Singapore",
    summary: "Co-authored two workshop papers on geometric deep learning and ran the GPU cluster.",
    achievements: [
      "Co-authored 2 NeurIPS workshop papers",
      "Maintained 16-node GPU cluster · 99.4% uptime",
      "Built the lab's data-pipeline framework (still in use)",
    ],
  ...
  },
  {
    id: "c5",
    company: "Shopee",
    position: "SWE Intern · Search",
    term: "2020",
    year: "2020",
    location: "Singapore",
    summary: "First role — shipped a query-rewrite component used in regional search.",
    achievements: [
      "Query-rewrite raised relevance@10 by 4.1%",
      "Wrote A/B harness used by team for 2 years after",
    ],
...
window.TESTIMONIALS = [
  { name: "Dr. Mei Zhao",   role: "Principal Researcher · A*STAR",      date: "Mar 2025", text: "Aloysius brings a rare combination of system-level rigor and product taste. His retrieval work on SYNAPSE is the most thoughtful graph-RAG implementation I've reviewed." },
  { name: "Lin Wei",         role: "Director of Engineering · GovTech",  date: "Aug 2024", text: "Reliably the engineer I assign the ambiguous problems to. Owns ambiguity, ships clean abstractions, and mentors juniors without being asked." },
  { name: "Priya Raghavan",  role: "Co-founder · Neural Interface Co.",  date: "Oct 2025", text: "He thinks in graphs. Whatever the domain — search, agents, mentorship — he finds the structure and ships an interface for it." },
  { name: "Hannah Tay",      role: "Engineering Manager · Sea",          date: "Dec 2023", text: "Gave him 800 services and a quarter. He gave us back a 38% tail-latency reduction and documentation other teams now copy." },
  { name: "Marcus Ong",      role: "Tech Lead · Antler SEA",             date: "Nov 2025", text: "His curation of Founders' Demo Night converted into three term sheets within 30 days. Every piece of his prep was overengineered, in the best way." },
  { name: "Dr. Aiden Park",  role: "Asst. Prof · NUS SoC",               date: "Jun 2022", text: "Most reliable RA I've worked with in a decade. His pipeline framework outlived three cohorts." },
  { name: "Jess Kuan",       role: "Staff SRE · Stripe SG",              date: "Feb 2025", text: "He treats observability as a design problem. PULSE.observe is the only side-project dashboard I check more than once." },
];
